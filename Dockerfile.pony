...
RUN apk add --no-cache wget && \
    wget -q -O /model.safetensors https://civitai.com/api/download/models/290640
...
RUN   echo "Downloading Upscalers"
    ...
    aria2c -o ESRGAN.pth https://github.com/cszn/KAIR/releases/download/v1.0/ESRGAN.pth
